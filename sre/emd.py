...
with open('C:/Users/Moh/SemanticSearchwithApproximateNearestNeighborsandTextEmbeddings/data/corpus/JLR.txt', 'w', encoding='utf-8') as out_file:
    with open('C:/Users/Moh/SemanticSearchwithApproximateNearestNeighborsandTextEmbeddings/data/corpus/JLR.tsv', 'r', encoding='utf-8') as in_file:
        for line in in_file:
...
args = {
    ...
    'runner': 'DirectRunner',
    'batch_size': 1024,
    'data_dir': 'C:/Users/Moh/SemanticSearchwithApproximateNearestNeighborsandTextEmbeddings/data/corpus/JLR.txt',
...
test_embeddings = extract_embeddings("Hello R&D team how are you doing today!")
